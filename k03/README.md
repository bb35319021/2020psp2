...
37 num_dummyの数までデータを捏造する

39 z変換の公式を用いて、標準化された値から一人のデータの値に変える
...
[comment #20200722]
- 結果自体はOKです.
- あとは`argc`を使って, コマンドライン引数の個数がおかしいときにエラーを出して終了するようにしましょう. 


[comment #20200729]
- OKです. 
- コマンドライン引数が足りなかったときは異常終了をさせたいので, ふつうは0以外の値をreturnさせます. その部分はこちらで追加しておきました.  
(exit(EXIT_FAILURE)を追加)